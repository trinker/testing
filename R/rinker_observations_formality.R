#' Observation Formality
#'
#' A dataset containing a formality object for observations.
#'
#' @details
#' \itemize{
...
#' @docType data
#' @keywords datasets
#' @name rinker_observations_formality
#' @usage data(rinker_observations_formality)
